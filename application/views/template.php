...
<head>
    ...
    <link href="<?php echo base_url() ?>assets/backend/libs/simple-datatables/style.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url() ?>assets/backend/libs/mobius1-selectr/selectr.min.css" rel="stylesheet" type="text/css" />
...
<body data-menu-color="light" data-sidebar="default" id="body">
                    ...
                    <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="<?php echo base_url('assets') ?>/user-black.png" alt="user-image" class="rounded-circle">
                ...
                <div id="sidebar-menu">
                    <div class="logo-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="<?php echo base_url('assets/') ?>logo.png" alt="" height="60">
                            </span>
                            <span class="logo-lg">
                                <img src="<?php echo base_url('assets/') ?>logo.png" alt="" height="60">
                            </span>
    ...
    'data'          => array(
        ...
        array(
            'title'     => 'Packages',
            'icon'      => 'fas fa-box-open', // ikon paket
            'url'       => 'admin/package',
            'notif'     => 0,
            'typenotif' => null,
            'submenu'   => FALSE,
        ...
        array(
            'title'     => 'About',
            'icon'      => 'fas fa-info-circle', // ikon tentang
            'url'       => 'admin/about',
            'notif'     => 0,
            'typenotif' => null,
            'submenu'   => FALSE,
        ...
        array(
            'title'     => 'Gallery',
            'icon'      => 'fas fa-images', // ikon galeri
            'url'       => 'admin/gallery',
            'notif'     => 0,
            'typenotif' => null,
            'submenu'   => FALSE,
        ...
        array(
            'title'     => 'Contact',
            'icon'      => 'fas fa-address-book', // ikon kontak
            'url'       => 'admin/contact',
            'notif'     => 0,
            'typenotif' => null,
            'submenu'   => FALSE,
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col fs-13 text-muted text-center">
                            ...
                            </script> <span class="mdi mdi-heart text-danger"></span> by <a href="#!" class="text-reset fw-semibold"> Travel</a>
                        </div>
                    </div>
                </div>
            </footer>
