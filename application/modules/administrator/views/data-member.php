<?php $this->template->title->set('Data Member'); ?>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <!-- SEARCH -->
        <form action="<?= site_url('admin/data-member') ?>" method="GET" class="mb-3">
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input name="search" id="search"
                        ...
                        placeholder="Cari berdasarkan username / nama lengkap" autocomplete="off">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    foreach ($getdata->result() as $user) {
                    ?>
                        <tr>
                            <td><?= $no++ ?></td>

                            <td>
                                <small class="text-danger"><?= $user->username ?></small><br>
                                <?= $user->user_fullname ?>
                            </td>
                            ...
                            <td>
                                <!-- <a data-bs-href="<?= site_url('modal/admin/member-update?code=' . $user->user_code) ?>"
                                    data-bs-title="Update Member"
        ...
        <!-- PAGINATION -->
        <div class="pt-2">
            <?= $this->paginationmodel->paginate('data-member', $Gettotal, $limit) ?>
        </div>
